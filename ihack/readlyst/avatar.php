...
function createAvatar($text,$settings = array()){
	...
	if(isset($settings['font'])){
		...
		$font = '/var/www/html/readlyst/assets/fonts/dancingscript/DancingScript-Bold.ttf';
	}
...
$settings = array("words"=>"two", "direction"=>"ltr", "shape" => "square");
if (isset($_GET['name']) && !empty($_GET['name'])) {    
	header("Content-Type: image/png");
	createAvatar($_GET['name'], $settings);
} else {
